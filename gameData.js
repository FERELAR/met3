...
"METAR UHHH 031430Z 23006MPS 9999 FEW018 M21/M25 Q1010 R88/850350 NOSIG RMK QFE751/1002=",
"METAR UHHH 021700Z 25009MPS 9999 DRSN NSC M19/M25 Q1012 R88/090060 NOSIG RMK QFE752/1003=",
"METAR UHHH 022000Z 30002MPS 2900 -SHRA BR FEW011 OVC015CB 07/07 Q0996 R88/290145 NOSIG RMK QFE741/0988=",
"METAR UHHH 022100Z 00000MPS 0500 0450SW R23R/0550N FG OVC002 15/15 Q1008 R23R/090060 NOSIG RMK QBB070 QFE750/1000=",
"METAR UIUU 031130Z 28003MPS 4400 FU BKN041CB M16/M18 Q1023 R26/490245 NOSIG RMK QFE723/0964=",
"METAR UIUU 030530Z VRB01MPS 1400 1200NW SHSN OVC012CB M17/M20 Q1022 R26/490250 NOSIG RMK QBB370 MT OBSC QFE722/0963=",
"METAR UIUU 031630Z 28003MPS 9999 FEW040CB M14/M18 Q1023 R26/490245 NOSIG RMK QFE723/0964=",
"METAR UIII 031300Z 00000MPS 2500 0900S FZFG NSC M09/M10 Q1022 R30/390137 NOSIG RMK QFE721/0962=",
"METAR UIII 030600Z 32002MPS 6000 -SHSN BKN009CB M08/M09 Q1022 RESHSN R30/490534 NOSIG RMK QBB290 MT OBSC QFE722/0962=",
"METAR UIII 022300Z 00000MPS 4600 -SHSN SCT050CB M15/M17 Q1020 RESHSN R30/490337 NOSIG RMK QFE720/0960=",
"METAR UIBB 161600Z AUTO 12002MPS 9999 // NCD M04/M08 Q1027 RMK QFE727/0969=",
"METAR UIBB 170900Z 27008G13MPS 230V300 0800 0650SE R30/0650D +SHSN BLSN VV005 M05/M07 Q1008 R30/450242 NOSIG RMK QBB170 MT OBSC QFE713/0951="
];
...
{question: "CAVOK включается в метеосводку если:", options: ["Видимость >10км, без особых явлений погоды, отсутствие CB/TCU, ВНГО не ниже 1500м или ясно, в горах не используется", "Горы открыты", "Видимость >10км, без особых явлений погоды,  ВНГО не ниже 1500м или ясно", "Видимость >10км, отсутствие CB/TCU, в горах не используется"], correct: 0},
{question: "Код для грозы", options: ["TS", "RA", "SN", "FG"], correct: 0},
{question: "Что значит NOSIG?", options: ["Без изменений", "Временами", "Прогноз на посадку", "С изменениями"], correct: 0},
...
{question: "Может ли быть CAVOK в Сочи?", options: ["да", "нет", "иногда", "не знаю"], correct: 1},
{question: "Что такое QNH?", options: ["Давление на уровне моря по СА", "Давление у порога ВПП приведена по условиям СА", "Давление на уровне моря по реальной атмосфере", "Давление у порога ВПП приведена по условиям реальной атмосферы"], correct: 0},
{question: "Что такое QFE?", options: ["Давление на уровне моря по реальной атмосфере", "Давление на уровне моря по СА", "Давление у порога ВПП приведена по условиям СА", "Давление у порога ВПП приведена по условиям реальной атмосферы"], correct: 2},
{question: "При каких значениях видимости ставится + перед осадками для указания сильной интенсивности?", options: ["<800м", "<1000м", "1000-2000м", ">2000м"], correct: 1},
{question: "VCTS – гроза в окрестности аэродрома. Какое растояние считается окрестностью аэродрома?", options: ["10км", "8-16км", "10-20км", "25км"], correct: 1},
{question: "Из какой облачности выпадают обложные осадки?", options: ["слоисто-кучевые", "слоистые", "слоисто-дождевые", "кучевые"], correct: 2},
{question: "Из какой облачности выпадают моросящие осадки?", options: ["слоисто-дождевые", "слоисто-низкие/слоисто-кучевые", "слоистые", "высоко-слоистые"], correct: 1},
{question: "Из какой облачности выпадают ливневые осадки?", options: ["слоисто-кучевые", "слоисто-дождевые", "кучево-дождевые", "кучевые"], correct: 2},
{question: "На какие периоды выпускают TAF?", options: ["9ч 12ч 24ч 30ч", "3ч 5ч 7ч 9ч", "6ч 9ч 24ч 30ч", "6ч 12ч 24ч 36ч"], correct: 2},
{question: "Какие метеорологические элементы включаются в прогноз TREND (прогноз на посадку)?", options: ["ветер видимость явления облачность температура давление", "видимость явления облачность давление", "ветер видимость явление", "ветер видимость явления облачность"], correct: 3},
{question: "В каких пределах действует прогноз по аэродрому?", options: ["до 5км от КТА", "до 10км от КТА", "до 8км от КТА", "от 8 до 16км от КТА"], correct: 2},
{question: "Как часто выпускается прогноз по аэродрому (TAF)?", options: ["каждый 1ч", "каждые 2ч", "каждые 3ч", "каждые 6ч"], correct: 2},
{question: "Какой период действия у прогноза на посадку?", options: ["1ч", "2ч", "3ч", "4ч"], correct: 1},
{question: "В метеосводке указывается 00000MPS (штиль) если скорость ветра:", options: ["1 м/c", "< 0.5 м/c", "< 1 м/c", "< 1.5 м/c"], correct: 1},
{question: "Как округляется высота облачности?", options: ["По правилам матиматического округления", "в большую сторону", "в меньшую сторону", "не округляется"], correct: 2}
];
